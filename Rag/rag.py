...
caminho_arquivos = r"C:\Users\nicol\OneDrive\Cursos online\Treinamento Python - Hashtag\Códigos\Rag Alexandre\Rag\Data"
...
COLLECTION_NAME = "livros_embeddings" # Um nome descritivo para sua tabela de vetores
...
for file_name in os.listdir(caminho_arquivos):
    ...
    if file_name.endswith(".docx"):
        ...
        try:
            ...
            print(f"Erro ao carregar DOCX {file_name}: {e}")
            continue
